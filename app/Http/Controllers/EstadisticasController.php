       ...
       $contador_esencial = DB::table('menus')
        ...
        $contador_pedidos_estaciones = Order::orderBy('created_at', 'DESC');
           ...
           if($request->select_estacion == 01){
            ...
            ->get();
            //dd($fecha2, $fecha1);
            return view('vendor.multiauth.admin.estadisticas.index',compact('contador_estados', 'contador_pedidos', 'contador_esencial', 'contador_principal', 'contador_secundario1', 'contador_secundario2', 'contador_envoltura', 'contador_ventas', 'contador_ventas_estaciones', 'contador_pedidos_estaciones'));
        }
