...
class ApiMeenuController extends Controller
{
    /**
    ...
    {
      $menu = DB::table('menus')->select('id', 'titulo', 'descripcion', 'precio', 'esencial', 'principal', 'secundario1', 'secundario2', 'envolturaInterna', 'envolturaExterna')->where('id', $id)->get();
